...
public class IdentityGlobalErrorHandler {
    ...
    ResponseEntity<ErrorResponse> handleAuth(AuthenticationException ex, HttpServletRequest req) {
        return ResponseEntity.status(HttpStatus.UNAUTHORIZED)
                ...
                .body(error(HttpStatus.UNAUTHORIZED, "identity.unauthorized", ex.getMessage(), req, null));
    }
    ...
    ResponseEntity<ErrorResponse> handleInvalidCredentials(InvalidCredentialsException ex, HttpServletRequest req) {
        return ResponseEntity.status(HttpStatus.UNAUTHORIZED)
                .header(HttpHeaders.WWW_AUTHENTICATE, "Bearer")
                .body(error(HttpStatus.UNAUTHORIZED, "identity.invalid_credentials", ex.getMessage(), req, null));
    }
    ...
    ResponseEntity<ErrorResponse> handlePasswordMismatch(PasswordConfirmationMismatchException ex,
                                                         HttpServletRequest req) {
        return build(HttpStatus.BAD_REQUEST, "identity.password_mismatch",
    ...
    private ErrorResponse error(HttpStatus status, String code, String message, HttpServletRequest req,
