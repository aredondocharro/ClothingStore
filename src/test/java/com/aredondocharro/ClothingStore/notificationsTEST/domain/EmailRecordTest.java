...
class EmailRecordTest {
    ...
    void requires_non_empty_to_subject_and_body() {
        ...
        assertThrows(IllegalArgumentException.class, () -> new Email(null, null, "s", "b", false));
        assertThrows(IllegalArgumentException.class, () -> new Email(null, List.of(), "s", "b", false));
        assertThrows(IllegalArgumentException.class, () -> new Email(null, to, " ", "b", false));
        assertThrows(IllegalArgumentException.class, () -> new Email(null, to, "s", " ", false));
